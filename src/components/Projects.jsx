  ...
  const projects = [
    {
      ...
      description:
        "I built a web-based CGPA/SGPA calculator aligned with the DSEU grading system, delivering 100% accurate results and reducing manual effort by 80%. Powered by JavaScript, it featured real-time calculations, input validation, and error handling, improving reliability by 95%. The tool was optimized for responsiveness and seamless use across five major browsers.",
  image: "/project1.jpg",
      technologies: ["JavaScript", "HTML5", "CSS3", "Bootstrap", "Responsive Design"],
      category: "utilities",
      demoUrl: "#",
      githubUrl: "#",
    },
    {
      ...
      description:
        "I created a React-based expense tracker handling 500+ transactions with real-time calculations and visualizations, reducing manual tracking by 90%. Built with modular components, the system improved maintainability and enabled new features 30% faster while ensuring responsive performance across devices.",
  image: "/project2.jpg",
    ...
    {
      id: 3,
      title: "Login & Register System with Database",
      description:
        "I engineered a secure authentication system using PHP, MySQL, and phpMyAdmin, successfully tested with 100+ users and managing 1,000+ records with 99% accuracy. By adding form validation, sanitization, and error handling, I reduced invalid submissions by 40% while maintaining responsive design and data security.",
  image: "/project3.jpg",
      technologies: ["PHP", "MySQL", "phpMyAdmin", "HTML5", "CSS3"],
      category: "secure",
      demoUrl: "#",
      githubUrl: "#",
    },
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    {/* <a
                      ...
                      className="p-2 bg-primary text-primary-foreground rounded-full hover:bg-primary/80 transition-colors animate-bounce"
                      title="Live Demo"
                    >
                    ...
                    <a
                      ...
                      className="p-2 bg-secondary text-secondary-foreground rounded-full hover:bg-secondary/80 transition-colors animate-bounce"
                      title="View Code"
